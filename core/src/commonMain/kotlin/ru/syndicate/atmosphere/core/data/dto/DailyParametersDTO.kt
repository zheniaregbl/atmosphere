...
data class DailyParametersDTO(
    ...
    @SerialName("surface_pressure_mean") val meanPressure: List<Double>,
    @SerialName("surface_pressure_max") val maxPressure: List<Double>,
    @SerialName("surface_pressure_min") val minPressure: List<Double>,
